class Hero:
	...
	def gainExp(self,input):
		self.__exp += input
		if(self.__exp >= 100): # >=100 naik level, experience 300 naik 3 level
			self.levelUp = self.__exp//100 #dibulatkan ke bawah
			self.__exp %= 100 #sisa pembagian pas dibagi 100
